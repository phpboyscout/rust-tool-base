...
#
# Assumes zensical is installed globally (e.g. `pipx install zensical`).
# The CI workflow installs from requirements-lock.txt for reproducibility;
# local contributors only need `zensical` on PATH.
